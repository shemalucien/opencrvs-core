...
Upgrading from v1.1.0 to v1.2.0 requires the upgrade [Migration Notes](v1.1.-to-v1.2.0-migration-notes.md) to be followed precisely.&#x20;
...
{% hint style="info" %}
Follow the[ Migration Notes ](v1.1.-to-v1.2.0-migration-notes.md)to migrate between versions of core
{% endhint %}
