...
7\. Deploy v1.2\* following the[ new deploy instructions](../../setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy.md) including the new secrets **MINIO\_ROOT\_USER** and **MINIO\_ROOT\_PASSWORD.**

8\. Migrations will automatically run on your data. You can check the progress status of your migrations in Kibana. &#x20;
