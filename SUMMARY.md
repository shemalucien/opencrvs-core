...
* [3. Installation](setup/3.-installation/README.md)
  ...
  * [3.2 Set-up your own country configuration](setup/3.-installation/3.2-set-up-your-own-country-configuration/README.md)
    ...
    * [3.2.7 Set up BRN/DRN registration and interoperability](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-set-up-brn-drn-registration-and-interoperability.md)
    * [3.2.8 Set up health facility notifications](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.8-set-up-health-facility-notifications.md)
