...
* [Function Architecture](product-specifications/functional-architecture/core-functions/README.md)
  ...
  * [Core functions](product-specifications/functional-architecture.md)
    * [Notify event](product-specifications/function-architecture/core-functions/notify-event.md)
    * [Declare event](product-specifications/function-architecture/core-functions/declare-event.md)
    ...
    * [Issue certificate](product-specifications/function-architecture/core-functions/issue-certificate.md)
    * [Correct record](product-specifications/function-architecture/core-functions/correct-record.md)
