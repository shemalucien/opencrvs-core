...
{% hint style="warning" %}
**Are you just upgrading from v1.2\* to a newer hotfix of v1.2\*?**  If so, you follow step 2 and step 3 then use the new version in your deploy scripts. Running Ansible changes and data migrations are required on any hotfix release. &#x20;
{% endhint %}
