...
* [Functional Architecture](product-specifications/functional-architecture/README.md)
  * [Users](product-specifications/functional-architecture/users/README.md)
    * [Tasks and permissions](product-specifications/functional-architecture/users/tasks-and-permissions.md)
    * [Examples](product-specifications/functional-architecture/users/examples.md)
  * [Core functions](product-specifications/functional-architecture/core-functions/README.md)
    * [Notify event](product-specifications/functional-architecture/core-functions/notify-event.md)
    * [Declare event](product-specifications/functional-architecture/core-functions/declare-event.md)
    * [Validate event](product-specifications/functional-architecture/core-functions/validate-event.md)
    * [Register event](product-specifications/functional-architecture/core-functions/register-event.md)
    * [Issue certificate](product-specifications/functional-architecture/core-functions/issue-certificate.md)
    * [Correct record](product-specifications/functional-architecture/core-functions/correct-record.md)
    * [Verify record](product-specifications/functional-architecture/core-functions/verify-record.md)
    * [Vital statistics export](product-specifications/functional-architecture/core-functions/vital-statistics-export.md)
