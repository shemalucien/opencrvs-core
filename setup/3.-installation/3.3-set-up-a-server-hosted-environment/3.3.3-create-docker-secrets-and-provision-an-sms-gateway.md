...
{% hint style="info" %}
You can choose the method of communications provider as long as it uses the mobile phone number of the informant or staff member.  Examples are SMS (In our example we use an SMS provider with example code for [Clickatell](https://www.clickatell.com/) and [Infobip](https://www.infobip.com/)), [WhatsApp](https://developers.facebook.com/docs/whatsapp/) or [Telegram](https://core.telegram.org/) for example. &#x20;
{% endhint %}
