...
Upgrading from v1.0.1 to v1.1.0 requires the upgrade [Migration Notes](broken-reference) to be followed precisely.&#x20;
...
[Requirement to duplicate Github Actions for deployment in a forked repo](../../setup/3.-installation/3.3-set-up-a-server-hosted-environment/3.3.6-deploy-automated-and-manual.md)
