...
The v1.1.0-stable release includes collective hot-fixes to stabilise the previous v1.0.1 minor patch release. &#x20;

Upgrading from v1.0.1 to v1.1.0 requires the upgrade Migration Notes to be followed precisely.  We strongly recommend that all implementers currently running v1.0.1 perform the upgrade to v1.1.0 as soon as possible.
