...
* [3. Installation](setup/3.-installation/README.md)
  ...
  * [3.2 Set-up your own country configuration](setup/3.-installation/3.2-set-up-your-own-country-configuration/README.md)
    ...
    * [3.2.2 Configure administrative address divisions](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.2-configure-administrative-address-divisions/README.md)
    ...
    * [3.2.3 Configure CR offices and Health facilities](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.3-configure-cr-offices-and-health-facilities.md)
    * [3.2.4 Configure employees for testing or production](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.4-configure-employees-for-testing-or-production.md)
