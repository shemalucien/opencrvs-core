...
* [3. Installation](setup/3.-installation/README.md)
  * [3.1 Set-up a development environment](setup/3.-installation/3.1-set-up-a-development-environment.md)
  * [3.2 Set-up address structure](setup/3.-installation/3.2-set-up-address-structure.md)
  * [3.3 Setup administrative areas](setup/3.-installation/3.3-setup-administrative-areas.md)
  * [3.4 Set-up health facilities](setup/3.-installation/3.4-set-up-health-facilities.md)
  * [3.7 Set-up a server-hosted environment](setup/3.-installation/3.7-set-up-a-server-hosted-environment.md)
