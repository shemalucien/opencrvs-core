...
* [3. Installation](setup/3.-installation/README.md)
  ...
  * [3.2 Set-up your own country configuration](setup/3.-installation/3.2-set-up-your-own-country-configuration/README.md)
    ...
    * [3.2.2 Set up administrative address divisions](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.2-configure-administrative-address-structure.md)
    ...
    * [3.2.3 Set up CR offices and Health facilities](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.3-configure-cr-offices-and-health-facilities/README.md)
    ...
    * [3.2.4 Set up employees for testing or production](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.4-import-employees-for-testing-or-production.md)
    ...
    * [3.2.7 Set up BRN/DRN registration and interoperability](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.7-configure-brn-drn-registration-and-interoperability.md)
    * [3.2.8 Set up health facility notifications](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.8-configure-health-facility-notifications.md)
    * [3.2.9 Set up required settings](setup/3.-installation/3.2-set-up-your-own-country-configuration/3.2.9-provision-required-settings.md)
